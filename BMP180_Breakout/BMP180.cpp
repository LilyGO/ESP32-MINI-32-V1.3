...
char MH_BMP180::readInt(char address, int16_t &value)
...
char MH_BMP180::readUInt(char address, uint16_t &value)
...
char MH_BMP180::readBytes(unsigned char *values, char length)
...
char MH_BMP180::writeBytes(unsigned char *values, char length)
...
char MH_BMP180::startTemperature(void)
...
char MH_BMP180::getTemperature(double &T)
...
char MH_BMP180::startPressure(char oversampling)
...
char MH_BMP180::getPressure(double &P, double &T)
...
double MH_BMP180::sealevel(double P, double A)
...
double MH_BMP180::altitude(double P, double P0)
